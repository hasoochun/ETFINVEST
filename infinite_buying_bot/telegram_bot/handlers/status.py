...
async def pnl_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        message = (
            f"💹 *Profit & Loss*\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"Total P&L:   `{pnl_icon} {pnl_sign}${pnl:,.2f}`\n"
            f"Return:      `{pnl_sign}{pnl_pct:.2f}%`\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"Today:       `{pnl_sign}${pnl_data.get('today_pnl', 0):.2f}`\n"
            f"This Week:   `{pnl_sign}${pnl_data.get('week_pnl', 0):.2f}`\n"
            f"This Month:  `{pnl_sign}${pnl_data.get('month_pnl', 0):.2f}`\n"
            f"━━━━━━━━━━━━━━━━━━━━"
        )
