...
class Trader:
    ...
    def buy(self, amount, split_count=None, reason=None):
        ...
        logger.info(f"?윟 Executing BUY: {qty} shares of {self.symbol} @ ${current_price:.2f}")
        
        # Send pre-trade notification
        pre_msg = (
            f"?윟 **BUY ORDER SUBMITTED**\n"
            f"?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺\n"
        ...
        pre_msg += f"?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺"
    ...
    def sell_all(self, quantity, reason=None):
        ...
        logger.info(f"?뵶 Executing SELL: {quantity} shares of {self.symbol} @ ${current_price:.2f}")
        
        # Send pre-trade notification
        pre_msg = (
            f"?뵶 **SELL ORDER SUBMITTED**\n"
            f"?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺\n"
            f"Symbol:      `{self.symbol}`\n"
        ...
        if not res.empty:
            ...
            success_msg = (
                ...
                f"?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺\n"
                f"?봽 Position closed - Strategy reset\n"
                f"?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺?곣봺"
            )
